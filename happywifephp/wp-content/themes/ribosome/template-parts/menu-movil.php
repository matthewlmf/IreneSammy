...
<div id="menu-movil">
	<div class="search-form-movil">
		<form method="get" id="searchform-movil" action="<?php echo esc_url( home_url( '/' ) ); ?>">
			...
			<input type="search" class="txt-search-movil" placeholder="<?php _e('Search...', 'ribosome'); ?>" name="s" id="s" />
			<input type="submit" name="submit" id="btn-search-movil" value="<?php _e( 'Search', 'ribosome' ); ?>" />
		</form>
