...
class white_Recent_Posts extends WP_Widget {

	public function __construct() {
		parent::__construct(
			'white_rp', // Base ID
			__('IH Recent Posts with Thumbnails', 'white'), // Name
			array( 'description' => __( 'Display your recent posts, with a Thumbnail.', 'white' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
 	...
 	public function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = __( 'Latest Articles', 'white' );
		}
...
add_action( 'widgets_init', 'register_white_widget' );  
function register_white_widget() {  
    register_widget( 'white_Recent_Posts' );  
}  
