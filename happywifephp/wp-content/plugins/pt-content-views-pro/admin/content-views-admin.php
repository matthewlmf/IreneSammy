...
class PT_Content_Views_Pro_Admin extends PT_Content_Views_Admin {
	...
	public function filter_setting_post_in( $args ) {
		$args = __( 'Drag and drop to change display order of them', 'content-views-pro' );
		return $args;
	}
							...
							array(
								...
								'params'		 => array(
									array(
										...
										'options'	 => PT_CV_Values::yes_no( 'yes', __( 'Set same width for all thumbnails', 'content-views-pro' ) ),
										'std'		 => '',
									),
								),
							),
							...
							array(
								...
								'params'		 => array(
									array(
										...
										'options'	 => PT_CV_Values::yes_no( 'yes', __( 'Set same height for all thumbnails', 'content-views-pro' ) ),
										'std'		 => '',
										'desc'		 => __( 'Not recommend, it can stretch thumbnails', 'content-views-pro' ),
									),
								),
							),
							// Regenerate image
							array(
								...
								'params'		 => array(
									array(
										...
										'std'		 => '',
										'desc'		 => __( 'Check this option if you changed thumbnail recently', 'content-views-pro' ),
									),
								),
			...
			$options = array(
				...
				array(
					...
					'params'		 => array(
						array(
							'type'		 => 'html',
							'content'	 => sprintf( '<p class="text-muted" style="margin-top: -10px;font-size: 13px;">%s.</p>', sprintf( __( 'Work with %s layout', 'content-views-pro' ), '<code>' . __( 'Grid', 'content-views-query-and-display-post-page' ) . ', ' . __( 'Pinterest', 'content-views-pro' ) . ', ' . __( 'Masonry', 'content-views-pro' ) . '</code>' ) ),
						),
					),
				),
				array(
												...
												array(
													...
													'params'		 => array(
														array(
															...
															'std'	 => 'and',
															'desc'	 => sprintf( __( '%s show posts which match all selected terms of taxonomy %s show posts which match at least one selected terms of taxonomy', 'content-views-pro' ), '<code>and</code>:', ', <code>or</code>:' ) . '.<br>' . sprintf( __( 'Separate operator for each taxonomy by comma, for example: %s', 'content-views-pro' ), '<code>or, or</code>' ),
														),
													),
												),
												array(
				...
				array(
					...
					'params'		 => array(
						array(
							...
							'std'		 => 'and',
							'desc'		 => sprintf( __( '%s show posts which match selected terms of all taxonomies %s show posts which match selected terms of at least one taxonomy', 'content-views-pro' ), '<code>and</code>:', ', <code>or</code>:' ),
						),
					),
					'dependence'	 => array( 'enable-' . $prefix, 'yes' ),
				),
				...
				array(
					...
					'params'		 => array(
						array(
							...
							'placeholder'	 => __( 'The "All" text', 'content-views-pro' ),
						),
					),
					'dependence'	 => array( 'enable-' . $prefix, 'yes' ),
				),
