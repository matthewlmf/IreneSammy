...
class Mega_Menu_Pro {
	...
	public function load() {
		...
		$classes = array(
			...
			'Mega_Menu_Effects' => $plugin_path . 'effects/effects.php',
    ...
    public function enqueue_public_scripts() {
        ...
        wp_enqueue_script( 'megamenu-pro', plugins_url( 'assets/public.js' , __FILE__ ), array('jquery', 'megamenu'), MEGAMENU_PRO_VERSION, true );
