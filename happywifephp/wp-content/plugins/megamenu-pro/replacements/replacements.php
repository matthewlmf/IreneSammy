...
class Mega_Menu_Replacements {
	...
	private function do_logo_replacement( $item, $item_output ) {
		...
		$logo_attributes = apply_filters( "megamenu_logo_attributes", array(
	...
	private function do_search_replacement( $item, $item_output ) {
		...
		if ( $type == 'expand_to_left' ) {
			$html = "<div class='mega-search-wrap'><form class='mega-search expand-to-left mega-search-closed' role='search' action='" .  trailingslashit( home_url() ) . "'>
		...
		if ( $type == 'expand_to_right' ) {
			$html = "<div class='mega-search-wrap'><form class='mega-search expand-to-right mega-search-closed' role='search' action='" .  trailingslashit( home_url() ) . "'>
				        <span class='dashicons dashicons-search search-icon'></span>
				        <input type='submit' value='" . __( "Search" , "megamenupro" ) . "'>
				        <input type='text' data-placeholder='{$placeholder}' name='s'>
				    </form></div>";
		...
		if ( $type == 'static' ) {
			$html = "<div class='mega-search-wrap'><form class='mega-search static mega-search-open' role='search' action='" .  trailingslashit( home_url() ) . "'>
				        <span class='dashicons dashicons-search search-icon'></span>
				        <input type='submit' value='" . __( "Search" , "megamenupro" ) . "'>
