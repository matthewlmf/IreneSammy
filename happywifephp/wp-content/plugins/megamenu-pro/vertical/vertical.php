            ...
            <tr class='megamenu_accordion_behaviour' style='display: <?php echo $display; ?>;'>
                ...
                <td>
                    <select name='megamenu_meta[<?php echo $location ?>][accordion_behaviour]'>
                        <option value='open_parents' <?php selected( isset($settings[$location]['accordion_behaviour']) && $settings[$location]['accordion_behaviour'] == 'open_parents' ) ?>><?php _e("Keep active submenus open", "megamenupro"); ?></option>
